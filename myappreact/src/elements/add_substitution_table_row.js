...
function AddSubstitutionRow(props){
    ...
    return (<tr className="add-substitution-row bg-gradient">
        ...
        <td className="no-search"><textarea className='w-100' name='comments' placeholder='Komentarz...' value={props.stateAddSubstitutionRow.comments} onChange={(ev)=>{props.handleInputChange(ev)}}></textarea></td>
