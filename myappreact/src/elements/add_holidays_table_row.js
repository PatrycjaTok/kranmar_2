...
function AddHolidaysRow(props){
    ...
    return (<tr className="add-holiday-row bg-gradient">
        ...
        <td></td>
        <td className="no-search"><textarea className='w-100' name='comments' placeholder='Komentarz...' value={props.stateAddHolidayRow.comments} onChange={(ev)=>{props.handleInputChange(ev)}}></textarea></td>
